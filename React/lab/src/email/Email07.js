...
function Email(props) {
    ...
    const successMessage = props.successMessage ?? "The email addresses are the same :)"
    ...
    return (
        ...
        <article className="box" style={{ backgroundColor: background, border: "solid " + borderThickness + "px" }}>
